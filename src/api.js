...
export const api = {
  ...
  gratitude: () => request('GET', '/gratitude'),
  addGratitude: (body) => request('POST', '/gratitude', { body }),
  checkin: () => request('GET', '/checkin'),
  submitCheckin: (answers) => request('POST', '/checkin', { answers }),
  ...
  revokeCoupon: (id) => request('POST', `/coupons/${id}/revoke`),
